...
Int_t TreeTracks::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t TreeTracks::LoadTree(Long64_t entry)
{
...
void TreeTracks::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("tan", &tan, &b_tan);
   fChain->SetBranchAddress("off", &off, &b_off);
   Notify();
}

Bool_t TreeTracks::Notify()
{
...
void TreeTracks::Show(Long64_t entry)
{
...
Int_t TreeTracks::Cut(Long64_t entry)
{
